...
#for more information on authentication using the api, please see here: https://support.zendesk.com/hc/en-us/articles/115000510267-How-can-I-authenticate-API-requests-
...
for item in data['tickets']:    
    ...
    target = zUM.slackUserLookup(zenAssignee) #lookup the zendeskUID using ZendeskUserMatch.py and return slackUID and store as target
    ...
    zenURL = 'https://your_subdomain.zendesk.com/agent/tickets/'+zenID #construct the user zendesk URL and store ##please put in your own zendesk URL
  ...
  blocks=[
    {
      ...
      "text": {
        "type": "mrkdwn",
        "text": '```This ticket has not had a public comment in 7 days. Please provide an update or close the ticket if solved!.```\n\n\n'
      }
    },
    {
      "type": "section",
