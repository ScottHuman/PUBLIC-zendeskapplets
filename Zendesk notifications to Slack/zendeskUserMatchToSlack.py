#instructions on how to lookup the ZENDESK USER ID: https://support.zendesk.com/hc/en-us/articles/360021164293-Is-there-a-user-id-that-is-not-the-user-email-address-
#instructions on how to lookup the SLACK USER ID: https://help.workast.com/hc/en-us/articles/360027461274-How-to-find-a-Slack-user-ID
